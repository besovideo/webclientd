<template>
  <div id="IMContent">
      <div class="im">
        <div id="layui-layim-chat" class="layui-layer-content" style="height: 408px;">
          <ul class="layui-unselect layim-chat-list">
            <li layim-event="tabChat" class="layim-group101 layim-chatlist-group101 layim-this">
              <img src="//tva1.sinaimg.cn/crop.0.0.200.200.50/006q8Q6bjw8f20zsdem2mj305k05kdfw.jpg" />
              <span>前端群</span>
              <i layim-event="closeChat" class="layui-icon">ဇ</i>
            </li>
          </ul>
          <div class="layim-chat-box" style="box-sizing:content-box;">
            <div class="layim-chat layim-chat-group layui-show">
              <div class="layui-unselect layim-chat-title">
                <div class="layim-chat-other">
                  <img
                    src="//tva1.sinaimg.cn/crop.0.0.200.200.50/006q8Q6bjw8f20zsdem2mj305k05kdfw.jpg"
                    class="layim-group101"
                  />
                  <span layim-event="groupMembers" class="layim-chat-username">
                    前端群
                    <em class="layim-chat-members">12人</em>
                ...
                <ul>
                  <li class="layim-chat-mine">
                    <div class="layim-chat-user">
                      ...
                      <cite>
                        <i>2019-08-01 10:58:00</i>纸飞机
                      </cite>
                    </div>
                    <div class="layim-chat-text">12312</div>
                  </li>
                  <li>
                    <div class="layim-chat-user">
                      <img src="https://res.layui.com/layui/dist/images/face/19.gif" />
                      <cite>
                        模拟群员15
                        <i>2019-08-01 10:58:01</i>
                      </cite>
                    </div>
                    <div class="layim-chat-text">
                      ...
                      <img
                        alt="[微笑]"
                        title="[微笑]"
                        src="https://res.layui.com/layui/dist/images/face/0.gif"
                      />
                    </div>
                  </li>
                  <li class="layim-chat-mine">
                    <div class="layim-chat-user">
                      <img src="//res.layui.com/images/fly/avatar/00.jpg" />
                      <cite>
                        <i>2019-08-01 10:58:26</i>纸飞机
                      </cite>
                    </div>
                    <div
                      class="layim-chat-text"
                    ></div>
                  </li>
                  <li>
                    <div class="layim-chat-user">
                      <img src="https://res.layui.com/layui/dist/images/face/4.gif" />
                      <cite>
                        模拟群员33
                        <i>2019-08-01 10:58:27</i>
                      </cite>
                    </div>
                    <div class="layim-chat-text">
                      ...
                      <img
                        alt="[心]"
                        title="[心]"
                        src="https://res.layui.com/layui/dist/images/face/47.gif"
                      />
                      <img
                        alt="[心]"
                        title="[心]"
                  ...
                  <li class="layim-chat-system">
                    <span>模拟群员51加入群聊</span>
                  </li>
                </ul>
              </div>
              <div class="layim-chat-footer">
                <div
                  data-json="%7B%22groupname%22%3A%22%E5%89%8D%E7%AB%AF%E7%BE%A4%22%2C%22id%22%3A%22101%22%2C%22avatar%22%3A%22%2F%2Ftva1.sinaimg.cn%2Fcrop.0.0.200.200.50%2F006q8Q6bjw8f20zsdem2mj305k05kdfw.jpg%22%2C%22name%22%3A%22%E5%89%8D%E7%AB%AF%E7%BE%A4%22%2C%22type%22%3A%22group%22%7D"
                  class="layui-unselect layim-chat-tool"
                >
                  <span title="选择表情" layim-event="face" class="layui-icon layim-tool-face"></span>
                  <span title="上传图片" layim-event="image" class="layui-icon layim-tool-image">
                    
                  ...
                  ></span>
                  <span layim-event="chatLog" class="layim-tool-log">
                ...
                <div class="layim-chat-bottom">
                  <div class="layim-chat-send">
                    <span layim-event="closeThisChat" class="layim-send-close">关闭</span>
                    <span layim-event="send" class="layim-send-btn">发送</span>
                    <span layim-event="setSend" lay-type="show" class="layim-send-set">
                      <em class="layui-edge"></em>
                    </span>
                    <ul class="layui-anim layim-menu-box">
                      <li layim-event="setSend" lay-type="Enter" class="layim-this">
