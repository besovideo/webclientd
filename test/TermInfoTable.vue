      ...
      <el-tabs type="border-card" style="height: 100%">
        <el-tab-pane label="基本信息">
          <div class="info_left" :style="{width:'50%',float:'left'}">
              ...
              <el-button style="margin-left:90px" type="primary" size="small" @click="UpdateDataInfo">应用</el-button>
              <el-button style="margin-left:10px" type="primary" :disabled="!online" size="small" @click="Reboot(0)">重启设备</el-button>
          </div>
        ...
        <el-tab-pane label="其他信息" class="OtherInfo">
